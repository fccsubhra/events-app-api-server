...
// variables:
//      https://github.com/fccsubhra/events-app-api-server.git
//      main
//      dtcaugust2021-214
//      api-server-image
//      cluster-1 
    ...
    stages {
        stage('Stage 1') {
            steps {
                ...
                git branch: 'main',
                    url: 'https://github.com/fccsubhra/events-app-api-server.git'
        ...
        stage('Stage 2') {
         ...
         stage('Stage 4') {
            steps {
                ...
                sh "gcloud builds submit -t gcr.io/dtcaugust2021-214/api-server-image:v2.${env.BUILD_ID} ."
            }
        }        
         stage('Stage 5') {
            steps {
